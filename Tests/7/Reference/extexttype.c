...
typedef struct SpamObject __pyx_gcc33_ject;
typedef struct Tomato __pyx_gcc33_;
typedef struct Bicycle __pyx_gcc33_e;
...
static PyTypeObject *__pyx_ptype_10extexttype_Spam = 0;
...
PyMODINIT_FUNC initextexttype(void); /*proto*/
PyMODINIT_FUNC initextexttype(void) {
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("extexttype", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  ...
  __pyx_ptype_10extexttype_Bicycle = __Pyx_ImportType("external", "Bicycle", sizeof(struct Bicycle)); if (!__pyx_ptype_10extexttype_Bicycle) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; goto __pyx_L1;}

  /* "/Local/Projects/C/Pyrex/Source/Tests/7/extexttype.pyx":7 */
  return;
  __pyx_L1:;
  __Pyx_AddTraceback("extexttype");
}
