/* Generated by Pyrex 0.9.5.2 on Fri Mar 30 15:39:02 2007 */
...
typedef struct __pyx_obj_12pyextattrref_Eggs __pyx_gcc33_obj_12pyextattrref_Eggs;
typedef struct __pyx_obj_12pyextattrref_Spam __pyx_gcc33_obj_12pyextattrref_Spam;
...
static void __pyx_f_12pyextattrref_tomato(struct __pyx_obj_12pyextattrref_Spam *__pyx_v_s) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/7/pyextattrref.pyx":8 */
...
PyMODINIT_FUNC initpyextattrref(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/7/pyextattrref.pyx":7 */
  return;
  __pyx_L1:;
