...
static double c_spam(int __pyx_v_i,float __pyx_v_f) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/7/cnamespec.pyx":14 */
  c_d = c_spam(c_a,__pyx_v_f);

  /* "/Local/Projects/C/Pyrex/Source/Tests/7/cnamespec.pyx":15 */
  c_b = __pyx_v_p->c_i;

  /* "/Local/Projects/C/Pyrex/Source/Tests/7/cnamespec.pyx":16 */
  __pyx_v_p->c_i = c_x;

  /* "/Local/Projects/C/Pyrex/Source/Tests/7/cnamespec.pyx":17 */
  __pyx_v_p->c_i = c_y;
...
PyMODINIT_FUNC initcnamespec(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/7/cnamespec.pyx":10 */
  return;
  __pyx_L1:;
