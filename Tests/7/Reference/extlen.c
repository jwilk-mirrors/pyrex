...
typedef struct __pyx_obj_6extlen_Spam __pyx_gcc33_obj_6extlen_Spam;
...
static int __pyx_f_6extlen_4Spam___len__(PyObject *__pyx_v_self); /*proto*/
static int __pyx_f_6extlen_4Spam___len__(PyObject *__pyx_v_self) {
  int __pyx_r;
  Py_INCREF(__pyx_v_self);

  /* "/Local/Projects/C/Pyrex/Source/Tests/7/extlen.pyx":4 */
  __pyx_r = 0;
  goto __pyx_L0;
...
static int __pyx_tp_traverse_6extlen_Spam(PyObject *o, visitproc v, void *a) {
  return 0;
}

static int __pyx_tp_clear_6extlen_Spam(PyObject *o) {
  return 0;
}
...
PyTypeObject __pyx_type_6extlen_Spam = {
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_6extlen_Spam, /*tp_traverse*/
  __pyx_tp_clear_6extlen_Spam, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
...
PyMODINIT_FUNC initextlen(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/7/extlen.pyx":3 */
  return;
  __pyx_L1:;
