/* Generated by Pyrex 0.9.6.2 on Mon Oct 15 19:10:17 2007 */
...
PyMODINIT_FUNC initcimportfunc(void); /*proto*/
PyMODINIT_FUNC initcimportfunc(void) {
  PyObject *__pyx_1 = 0;
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("cimportfunc", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  ...
  __pyx_L1:;
  Py_XDECREF(__pyx_1);
  __Pyx_AddTraceback("cimportfunc");
}
...
static int __Pyx_ImportFunction(PyObject *module, char *funcname, void **f, char *sig) {
	...
	d = PyObject_GetAttrString(module, "__pyx__capi__");
	if (!d)
		goto bad;
