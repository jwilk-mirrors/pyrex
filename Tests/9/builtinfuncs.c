/* Generated by Pyrex 0.9.6.4 on Sat Mar 29 13:27:31 2008 */
...
static int __pyx_f_12builtinfuncs_f(void) {
  ...
  __pyx_5 = PyObject_Length(__pyx_v_x); if (__pyx_5 == -1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; goto __pyx_L1;}
  __pyx_v_i = __pyx_5;

  /* "/Local/Projects/D/Pyrex/Source/Tests/9/builtinfuncs.pyx":17 */
  __pyx_1 = __Pyx_GetName(__pyx_b, __pyx_n_open); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; goto __pyx_L1;}
  __pyx_6 = PyTuple_New(2); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; goto __pyx_L1;}
  Py_INCREF(__pyx_v_y);
  PyTuple_SET_ITEM(__pyx_6, 0, __pyx_v_y);
  Py_INCREF(__pyx_v_z);
  PyTuple_SET_ITEM(__pyx_6, 1, __pyx_v_z);
  __pyx_7 = PyObject_CallObject(__pyx_1, __pyx_6); if (!__pyx_7) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; goto __pyx_L1;}
  ...
  __pyx_1 = PyNumber_Power(__pyx_v_y,__pyx_v_z,__pyx_v_w); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; goto __pyx_L1;}
  Py_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_1;
  __pyx_1 = 0;

  /* "/Local/Projects/D/Pyrex/Source/Tests/9/builtinfuncs.pyx":19 */
  __pyx_6 = PyImport_ReloadModule(__pyx_v_y); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; goto __pyx_L1;}
  Py_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_6;
  __pyx_6 = 0;

  /* "/Local/Projects/D/Pyrex/Source/Tests/9/builtinfuncs.pyx":20 */
  __pyx_7 = PyObject_Repr(__pyx_v_y); if (!__pyx_7) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; goto __pyx_L1;}
  Py_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_7;
  __pyx_7 = 0;

  /* "/Local/Projects/D/Pyrex/Source/Tests/9/builtinfuncs.pyx":21 */
  __pyx_3 = PyObject_SetAttr(__pyx_v_x,__pyx_v_y,__pyx_v_z); if (__pyx_3 == -1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; goto __pyx_L1;}

  /* "/Local/Projects/D/Pyrex/Source/Tests/9/builtinfuncs.pyx":22 */
  __pyx_1 = __Pyx_GetName(__pyx_b, __pyx_n_abs); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; goto __pyx_L1;}
  Py_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_1;
  __pyx_1 = 0;
