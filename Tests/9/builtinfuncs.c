/* Generated by Pyrex 0.9.6.4 on Sun Mar 30 09:50:09 2008 */
...
static int __pyx_f_12builtinfuncs_f(void) {
  ...
  __pyx_1 = PyTuple_New(2); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; goto __pyx_L1;}
  Py_INCREF(__pyx_v_y);
  PyTuple_SET_ITEM(__pyx_1, 0, __pyx_v_y);
  Py_INCREF(__pyx_v_z);
  PyTuple_SET_ITEM(__pyx_1, 1, __pyx_v_z);
  __pyx_6 = PyObject_CallObject(((PyObject *)(&PyFile_Type)), __pyx_1); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; goto __pyx_L1;}
  ...
  __pyx_1 = PyObject_Repr(__pyx_v_y); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; goto __pyx_L1;}
  Py_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_1;
  __pyx_1 = 0;
  ...
  __pyx_6 = __Pyx_GetName(__pyx_b, __pyx_n_abs); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 22; goto __pyx_L1;}
  Py_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_6;
  __pyx_6 = 0;
