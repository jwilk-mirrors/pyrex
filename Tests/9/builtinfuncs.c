...
static int __pyx_f_12builtinfuncs_f(void) {
  ...
  __pyx_4 = PyObject_Hash(__pyx_v_y); if (__pyx_4 == -1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; goto __pyx_L1;}
  __pyx_v_i = __pyx_4;

  /* "/Local/Projects/D/Pyrex/Source/Tests/9/builtinfuncs.pyx":12 */
  __pyx_5 = PyString_AsString(__pyx_v_y); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; goto __pyx_L1;}
  __pyx_1 = PyString_InternFromString(__pyx_5); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; goto __pyx_L1;}
  Py_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_1;
  __pyx_1 = 0;
  ...
  __pyx_6 = PyObject_Length(__pyx_v_x); if (__pyx_6 == -1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; goto __pyx_L1;}
  __pyx_v_i = __pyx_6;
  ...
  __pyx_7 = PyObject_CallObject(((PyObject *)(&PyFile_Type)), __pyx_1); if (!__pyx_7) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; goto __pyx_L1;}
  ...
  __pyx_7 = PyImport_ReloadModule(__pyx_v_y); if (!__pyx_7) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; goto __pyx_L1;}
  Py_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_7;
  __pyx_7 = 0;
  ...
  __pyx_7 = __Pyx_GetName(__pyx_b, __pyx_n_abs); if (!__pyx_7) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; goto __pyx_L1;}
  Py_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_7;
  __pyx_7 = 0;
