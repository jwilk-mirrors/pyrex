/* Generated by Pyrex 0.9.6.3 on Sun Oct 21 13:08:36 2007 */
...
static int __pyx_f_12builtinfuncs_f(void) {
  ...
  __pyx_6 = PyImport_ReloadModule(__pyx_v_y); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; goto __pyx_L1;}
  Py_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_6;
  __pyx_6 = 0;

  /* "/Local/Projects/D/Pyrex/Source/Tests/9/builtinfuncs.pyx":19 */
  __pyx_7 = PyObject_Repr(__pyx_v_y); if (!__pyx_7) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; goto __pyx_L1;}
  Py_DECREF(__pyx_v_x);
  __pyx_v_x = __pyx_7;
  __pyx_7 = 0;
