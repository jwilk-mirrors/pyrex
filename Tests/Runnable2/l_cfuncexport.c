/* Generated by Pyrex 0.9.6.1 on Wed Oct 10 23:36:34 2007 */
...
static int __pyx_f_13l_cfuncexport_f(int __pyx_v_x) {
  int __pyx_r;
...
static int __pyx_f_13l_cfuncexport_g(int __pyx_v_x) {
  int __pyx_r;
  __pyx_r = (5 * __pyx_v_x);
  goto __pyx_L0;
...
PyMODINIT_FUNC initl_cfuncexport(void); /*proto*/
PyMODINIT_FUNC initl_cfuncexport(void) {
  PyObject *__pyx_1 = 0;
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("l_cfuncexport", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  ...
  /* "/Local/Projects/D/Pyrex/Source/Tests/Runnable2/l_cfuncexport.pyx":4 */
  return;
  __pyx_L1:;
  Py_XDECREF(__pyx_1);
  __Pyx_AddTraceback("l_cfuncexport");
}
