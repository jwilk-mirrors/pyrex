...
PyMODINIT_FUNC initcimport(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/8/cimport.pyx":7 */
  eat(__pyx_v_7cimport_yummy);

  /* "/Local/Projects/C/Pyrex/Source/Tests/8/cimport.pyx":8 */
  tons = 3.14;

  /* "/Local/Projects/C/Pyrex/Source/Tests/8/cimport.pyx":9 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/8/cimport.pyx":10 */
