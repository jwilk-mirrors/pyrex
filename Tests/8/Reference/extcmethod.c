...
/* Declarations from extcmethod */

typedef struct __pyx_obj_10extcmethod_Spam __pyx_gcc33_obj_10extcmethod_Spam;
typedef struct __pyx_obj_10extcmethod_SuperSpam __pyx_gcc33_obj_10extcmethod_SuperSpam;


struct __pyx_obj_10extcmethod_Spam {
  PyObject_HEAD
  struct __pyx_vtabstruct_10extcmethod_Spam *__pyx_vtab;
  int tons;
};

struct __pyx_obj_10extcmethod_SuperSpam {
  struct __pyx_obj_10extcmethod_Spam __pyx_base;
};

struct __pyx_vtabstruct_10extcmethod_Spam {
  void ((*add_tons)(struct __pyx_obj_10extcmethod_Spam *,int ));
  void ((*eat)(struct __pyx_obj_10extcmethod_Spam *));
};
static struct __pyx_vtabstruct_10extcmethod_Spam *__pyx_vtabptr_10extcmethod_Spam;


struct __pyx_vtabstruct_10extcmethod_SuperSpam {
  struct __pyx_vtabstruct_10extcmethod_Spam __pyx_base;
};
static struct __pyx_vtabstruct_10extcmethod_SuperSpam *__pyx_vtabptr_10extcmethod_SuperSpam;

static PyTypeObject *__pyx_ptype_10extcmethod_Spam = 0;
static PyTypeObject *__pyx_ptype_10extcmethod_SuperSpam = 0;
...
static void __pyx_f_10extcmethod_4Spam_add_tons(struct __pyx_obj_10extcmethod_Spam *__pyx_v_self,int __pyx_v_x) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/8/extcmethod.pyx":6 */
...
static void __pyx_f_10extcmethod_4Spam_eat(struct __pyx_obj_10extcmethod_Spam *__pyx_v_self) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/8/extcmethod.pyx":9 */
  __pyx_v_self->tons = 0;
...
static void __pyx_f_10extcmethod_9SuperSpam_add_tons(struct __pyx_obj_10extcmethod_SuperSpam *__pyx_v_self,int __pyx_v_x) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/8/extcmethod.pyx":15 */
...
static PyObject *__pyx_tp_new_10extcmethod_Spam(PyTypeObject *t, PyObject *a, PyObject *k) {
  ...
  struct __pyx_obj_10extcmethod_Spam *p = (struct __pyx_obj_10extcmethod_Spam *)o;
...
static PyObject *__pyx_tp_new_10extcmethod_SuperSpam(PyTypeObject *t, PyObject *a, PyObject *k) {
  ...
  struct __pyx_obj_10extcmethod_SuperSpam *p = (struct __pyx_obj_10extcmethod_SuperSpam *)o;
...
PyMODINIT_FUNC initextcmethod(void) {
  ...
  *(void(**)(void))&__pyx_vtable_10extcmethod_SuperSpam.__pyx_base.add_tons = (void(*)(void))__pyx_f_10extcmethod_9SuperSpam_add_tons;
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/8/extcmethod.pyx":14 */
  return;
  __pyx_L1:;
