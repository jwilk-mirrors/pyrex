...
typedef struct __pyx_obj_13includepublic_sandwich __pyx_gcc33_obj_13includepublic_sandwich;
...
__PYX_EXTERN_C PyObject *(spam(int )); /*proto*/
...
PyMODINIT_FUNC initincludepublic(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/8/i_public.pxi":5 */
  return;
  __pyx_L1:;
