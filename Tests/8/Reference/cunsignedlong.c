...
static void __pyx_f_13cunsignedlong_f(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/8/cunsignedlong.pyx":4 */
  __pyx_1 = PyInt_AsUnsignedLongMask(__pyx_v_y); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; goto __pyx_L1;}
  __pyx_v_x = __pyx_1;

  /* "/Local/Projects/C/Pyrex/Source/Tests/8/cunsignedlong.pyx":5 */
...
PyMODINIT_FUNC initcunsignedlong(void); /*proto*/
PyMODINIT_FUNC initcunsignedlong(void) {
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("cunsignedlong", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  if (!__pyx_m) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; goto __pyx_L1;};
  __pyx_b = PyImport_AddModule("__builtin__");
  if (!__pyx_b) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; goto __pyx_L1;};
  if (PyObject_SetAttrString(__pyx_m, "__builtins__", __pyx_b) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; goto __pyx_L1;};

  /* "/Local/Projects/C/Pyrex/Source/Tests/8/cunsignedlong.pyx":1 */
  return;
  __pyx_L1:;
