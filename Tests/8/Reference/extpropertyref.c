...
typedef struct __pyx_obj_14extpropertyref_Spam __pyx_gcc33_obj_14extpropertyref_Spam;
...
static PyObject *__pyx_f_14extpropertyref_4Spam_4eggs___get__(PyObject *__pyx_v_self) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/8/extpropertyref.pyx":6 */
...
static void __pyx_f_14extpropertyref_tomato(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/8/extpropertyref.pyx":11 */
...
PyMODINIT_FUNC initextpropertyref(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/8/extpropertyref.pyx":8 */
  return;
  __pyx_L1:;
