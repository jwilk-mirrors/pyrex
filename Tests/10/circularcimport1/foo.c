/* Generated by Pyrex 0.9.8 on Sat May 17 14:59:57 2008 */
...
PyMODINIT_FUNC initfoo(void) {
  ...
  __pyx_ptype_5blarg_Blarg = __Pyx_ImportType("blarg", "Blarg", sizeof(struct __pyx_obj_5blarg_Blarg)); if (!__pyx_ptype_5blarg_Blarg) {__pyx_filename = __pyx_f[1]; __pyx_lineno = 9; goto __pyx_L1;}
  return;
  __pyx_L1:;
