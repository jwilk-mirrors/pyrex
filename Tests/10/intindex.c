/* Generated by Pyrex 0.9.6.4 on Sun Mar 30 10:53:42 2008 */
...
static int __pyx_f_8intindex_f(void) {
  ...
  __pyx_1 = PySequence_GetItem(__pyx_v_x, __pyx_v_i); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; goto __pyx_L1;}
  Py_DECREF(__pyx_v_z);
  __pyx_v_z = __pyx_1;
  __pyx_1 = 0;
