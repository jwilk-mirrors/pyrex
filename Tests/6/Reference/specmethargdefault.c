...
typedef struct __pyx_obj_18specmethargdefault_Grail __pyx_gcc33_obj_18specmethargdefault_Grail;
...
static int __pyx_f_18specmethargdefault_5Grail___new__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_f_18specmethargdefault_5Grail___new__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/6/specmethargdefault.pyx":4 */
...
static int __pyx_f_18specmethargdefault_5Grail___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/6/specmethargdefault.pyx":7 */
...
static PyObject *__pyx_tp_new_18specmethargdefault_Grail(PyTypeObject *t, PyObject *a, PyObject *k) {
  ...
  if (__pyx_f_18specmethargdefault_5Grail___new__(o, a, k) < 0) {
    Py_DECREF(o); o = 0;
  }
  return o;
}
...
static int __pyx_tp_traverse_18specmethargdefault_Grail(PyObject *o, visitproc v, void *a) {
  return 0;
}

static int __pyx_tp_clear_18specmethargdefault_Grail(PyObject *o) {
  return 0;
}
...
PyTypeObject __pyx_type_18specmethargdefault_Grail = {
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_18specmethargdefault_Grail, /*tp_traverse*/
  __pyx_tp_clear_18specmethargdefault_Grail, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
...
PyMODINIT_FUNC initspecmethargdefault(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/6/specmethargdefault.pyx":3 */
  Py_INCREF(Py_None);
  __pyx_k1 = Py_None;

  /* "/Local/Projects/C/Pyrex/Source/Tests/6/specmethargdefault.pyx":6 */
