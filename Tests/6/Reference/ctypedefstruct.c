...
/* Declarations from ctypedefstruct */


typedef struct {
  int spam;
  int eggs;
} __pyx_t_14ctypedefstruct_order;
...
PyMODINIT_FUNC initctypedefstruct(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/6/ctypedefstruct.pyx":7 */
  __pyx_v_14ctypedefstruct_order1.spam = 7;

  /* "/Local/Projects/C/Pyrex/Source/Tests/6/ctypedefstruct.pyx":8 */
