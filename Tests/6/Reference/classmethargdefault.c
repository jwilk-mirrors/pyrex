...
static PyObject *__pyx_f_19classmethargdefault_7Swallow_spam(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/6/classmethargdefault.pyx":4 */
...
PyMODINIT_FUNC initclassmethargdefault(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/6/classmethargdefault.pyx":1 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/6/classmethargdefault.pyx":3 */
  __pyx_k2 = 42;
  ...
  if (PyObject_SetAttr(__pyx_m, __pyx_n_Swallow, __pyx_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; goto __pyx_L1;}
