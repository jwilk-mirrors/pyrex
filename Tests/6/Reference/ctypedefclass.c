/* Generated by Pyrex 0.9.6.4 on Thu Mar 27 20:22:34 2008 */
...
/* Declarations from ctypedefclass */

typedef struct {
  PyObject_HEAD
} __pyx_obj_13ctypedefclass_spam;


static PyTypeObject *__pyx_ptype_13ctypedefclass_spam = 0;
...
static void __pyx_tp_dealloc_13ctypedefclass_spam(PyObject *o) {
  (*o->ob_type->tp_free)(o);
}
...
PyTypeObject __pyx_type_13ctypedefclass_spam = {
  PyObject_HEAD_INIT(0)
  0, /*ob_size*/
  "ctypedefclass.spam", /*tp_name*/
  sizeof(__pyx_obj_13ctypedefclass_spam), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_13ctypedefclass_spam, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  0, /*tp_compare*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_13ctypedefclass_spam, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_13ctypedefclass_spam, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
PyMODINIT_FUNC initctypedefclass(void); /*proto*/
PyMODINIT_FUNC initctypedefclass(void) {
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("ctypedefclass", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  ...
  __pyx_ptype_13ctypedefclass_spam = &__pyx_type_13ctypedefclass_spam;

  /* "/Local/Projects/D/Pyrex/Source/Tests/6/ctypedefclass.pyx":6 */
  Py_INCREF(Py_None);
  Py_DECREF(((PyObject *)__pyx_v_13ctypedefclass_s));
  __pyx_v_13ctypedefclass_s = ((__pyx_obj_13ctypedefclass_spam *)Py_None);
  return;
  __pyx_L1:;
  __Pyx_AddTraceback("ctypedefclass");
}
