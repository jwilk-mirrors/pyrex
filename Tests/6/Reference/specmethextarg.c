/* Generated by Pyrex 0.9.5.2 on Fri Mar 30 15:33:42 2007 */
...
/* Declarations from specmethextarg */

typedef struct __pyx_obj_14specmethextarg_Spam __pyx_gcc33_obj_14specmethextarg_Spam;


struct __pyx_obj_14specmethextarg_Spam {
  PyObject_HEAD
  int eggs;
};

static PyTypeObject *__pyx_ptype_14specmethextarg_Spam = 0;
...
static PyObject *__pyx_f_14specmethextarg_4Spam___iadd__(PyObject *__pyx_v_self, PyObject *__pyx_v_other) {
  ...
  if (!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_other), __pyx_ptype_14specmethextarg_Spam, 1, "other")) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 4; goto __pyx_L1;}

  /* "/Local/Projects/C/Pyrex/Source/Tests/6/specmethextarg.pyx":5 */
...
static int __pyx_tp_traverse_14specmethextarg_Spam(PyObject *o, visitproc v, void *a) {
  return 0;
}

static int __pyx_tp_clear_14specmethextarg_Spam(PyObject *o) {
  return 0;
}
...
PyTypeObject __pyx_type_14specmethextarg_Spam = {
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_14specmethextarg_Spam, /*tp_traverse*/
  __pyx_tp_clear_14specmethextarg_Spam, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
...
PyMODINIT_FUNC initspecmethextarg(void) {
  ...
  if (PyType_Ready(&__pyx_type_14specmethextarg_Spam) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "Spam", (PyObject *)&__pyx_type_14specmethextarg_Spam) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; goto __pyx_L1;}
  __pyx_ptype_14specmethextarg_Spam = &__pyx_type_14specmethextarg_Spam;

  /* "/Local/Projects/C/Pyrex/Source/Tests/6/specmethextarg.pyx":4 */
  return;
  __pyx_L1:;
