...
static PyObject *__pyx_n_resting;
static PyObject *__pyx_n_answer;
...
static PyObject *__pyx_f_4dict_f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/2/dict.pyx":2 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/2/dict.pyx":3 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/2/dict.pyx":4 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/2/dict.pyx":5 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/2/dict.pyx":6 */
...
static __Pyx_InternTabEntry __pyx_intern_tab[] = {
  {&__pyx_n_answer, "answer"},
  {&__pyx_n_f, "f"},
  {&__pyx_n_parrot, "parrot"},
  {&__pyx_n_resting, "resting"},
  {0, 0}
};

static struct PyMethodDef __pyx_methods[] = {
  {"f", (PyCFunction)__pyx_f_4dict_f, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};

static void __pyx_init_filenames(void); /*proto*/

PyMODINIT_FUNC initdict(void); /*proto*/
PyMODINIT_FUNC initdict(void) {
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("dict", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/2/dict.pyx":1 */
  return;
  __pyx_L1:;
  __Pyx_AddTraceback("dict");
}
