...
static PyObject *__pyx_f_6cnumop_f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/2/cnumop.pyx":7 */
  __pyx_v_int1 = (__pyx_v_int2 * __pyx_v_int3);

  /* "/Local/Projects/C/Pyrex/Source/Tests/2/cnumop.pyx":8 */
  __pyx_v_int1 = (__pyx_v_int2 / __pyx_v_int3);

  /* "/Local/Projects/C/Pyrex/Source/Tests/2/cnumop.pyx":9 */
  __pyx_v_long1 = (__pyx_v_long2 * __pyx_v_char1);

  /* "/Local/Projects/C/Pyrex/Source/Tests/2/cnumop.pyx":10 */
  __pyx_v_float1 = (__pyx_v_int1 * __pyx_v_float2);

  /* "/Local/Projects/C/Pyrex/Source/Tests/2/cnumop.pyx":11 */
...
PyMODINIT_FUNC initcnumop(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/2/cnumop.pyx":1 */
  return;
  __pyx_L1:;
