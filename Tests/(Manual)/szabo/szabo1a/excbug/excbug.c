/* Generated by Pyrex 0.9.8.5 on Mon Feb 15 13:42:53 2010 */
...
static char __pyx_k1[] = "iowrap";
static char __pyx_k2[] = "f ->";
static char __pyx_k3[] = "returning";

static PyObject *__pyx_n_iowrap;
static PyObject *__pyx_n_returning;

static PyObject *__pyx_k2p;

static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_n_iowrap, 1, __pyx_k1, sizeof(__pyx_k1)},
  {&__pyx_n_returning, 1, __pyx_k3, sizeof(__pyx_k3)},
...
static int __Pyx_GetException(PyObject **type, PyObject **value, PyObject **tb) {
	...
	printf("PyErr_Fetch: tb = %p\n", *tb);
	PyErr_NormalizeException(type, value, tb);
	printf("PyErr_NormalizeException: tb = %p\n", *tb);
	if (PyErr_Occurred())
		goto bad;
	Py_XINCREF(*type);
	Py_XINCREF(*value);
