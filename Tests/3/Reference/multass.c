...
static void __pyx_f_7multass_f(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/3/multass.pyx":5 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/3/multass.pyx":6 */
  __pyx_1 = __pyx_v_obj1b;
  Py_INCREF(__pyx_1);
  __pyx_2 = __pyx_v_obj2b;
  Py_INCREF(__pyx_2);
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/3/multass.pyx":7 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/3/multass.pyx":8 */
...
PyMODINIT_FUNC initmultass(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/3/multass.pyx":1 */
  return;
  __pyx_L1:;
