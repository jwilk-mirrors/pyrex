...
static PyObject *__pyx_f_5while_f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":7 */
  while (1) {
    ...
    /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":8 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":10 */
  while (1) {
    __pyx_1 = __pyx_v_i;
    if (!__pyx_1) break;

    /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":11 */
  ...
  /*else*/ {
    ...
    /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":13 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":15 */
  while (1) {
    __pyx_1 = __pyx_v_i;
    if (!__pyx_1) break;

    /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":16 */
    __pyx_2 = PyInt_FromLong(1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; goto __pyx_L1;}
    Py_DECREF(__pyx_v_x);
    __pyx_v_x = __pyx_2;
    __pyx_2 = 0;

    /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":17 */
    goto __pyx_L9;

    /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":18 */
  ...
  /*else*/ {
    ...
    /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":20 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":22 */
  while (1) {
    __pyx_1 = __pyx_v_i;
    if (!__pyx_1) break;

    /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":23 */
    __pyx_2 = PyInt_FromLong(1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; goto __pyx_L1;}
    Py_DECREF(__pyx_v_x);
    __pyx_v_x = __pyx_2;
    __pyx_2 = 0;

    /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":24 */
    goto __pyx_L10;

    /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":25 */
...
PyMODINIT_FUNC initwhile(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/3/while.pyx":1 */
  return;
  __pyx_L1:;
