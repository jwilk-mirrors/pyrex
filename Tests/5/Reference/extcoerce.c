...
typedef struct __pyx_obj_9extcoerce_Grail __pyx_gcc33_obj_9extcoerce_Grail;
typedef struct __pyx_obj_9extcoerce_Swallow __pyx_gcc33_obj_9extcoerce_Swallow;
...
static PyObject *__pyx_f_9extcoerce_5Grail___add__(PyObject *__pyx_arg_x, PyObject *__pyx_arg_y) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/5/extcoerce.pyx":4 */
...
static PyObject *__pyx_f_9extcoerce_5Grail___getslice__(PyObject *__pyx_v_self, int __pyx_arg_i, int __pyx_arg_j); /*proto*/
static PyObject *__pyx_f_9extcoerce_5Grail___getslice__(PyObject *__pyx_v_self, int __pyx_arg_i, int __pyx_arg_j) {
  PyObject *__pyx_v_i = 0;
  PyObject *__pyx_v_j = 0;
  PyObject *__pyx_r;
  Py_INCREF(__pyx_v_self);
  __pyx_v_i = PyInt_FromLong(__pyx_arg_i); if (!__pyx_v_i) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; goto __pyx_L1;}
  __pyx_v_j = PyInt_FromLong(__pyx_arg_j); if (!__pyx_v_j) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; goto __pyx_L1;}

  /* "/Local/Projects/C/Pyrex/Source/Tests/5/extcoerce.pyx":7 */
...
static int __pyx_f_9extcoerce_5Grail___setslice__(PyObject *__pyx_v_self, int __pyx_v_i, int __pyx_arg_j, PyObject *__pyx_v_x); /*proto*/
static int __pyx_f_9extcoerce_5Grail___setslice__(PyObject *__pyx_v_self, int __pyx_v_i, int __pyx_arg_j, PyObject *__pyx_v_x) {
  float __pyx_v_j;
  int __pyx_r;
  Py_INCREF(__pyx_v_self);
  Py_INCREF(__pyx_v_x);
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/5/extcoerce.pyx":10 */
...
static PyObject *__pyx_f_9extcoerce_f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/5/extcoerce.pyx":18 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/5/extcoerce.pyx":19 */
  Py_INCREF(((PyObject *)__pyx_v_g));
  Py_DECREF(__pyx_v_x);
  __pyx_v_x = ((PyObject *)__pyx_v_g);

  /* "/Local/Projects/C/Pyrex/Source/Tests/5/extcoerce.pyx":20 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/5/extcoerce.pyx":23 */
...
static int __pyx_sq_ass_slice_9extcoerce_Grail(PyObject *o, int i, int j, PyObject *v) {
  if (v) {
...
PyMODINIT_FUNC initextcoerce(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/5/extcoerce.pyx":15 */
  return;
  __pyx_L1:;
