/* Generated by Pyrex 0.9.5.2 on Fri Mar 30 15:28:13 2007 */
...
typedef struct __pyx_obj_10docstrings_SuperParrot __pyx_gcc33_obj_10docstrings_SuperParrot;
...
static int __pyx_tp_traverse_10docstrings_SuperParrot(PyObject *o, visitproc v, void *a) {
  return 0;
}

static int __pyx_tp_clear_10docstrings_SuperParrot(PyObject *o) {
  return 0;
}
...
PyTypeObject __pyx_type_10docstrings_SuperParrot = {
  ...
  __pyx_tp_traverse_10docstrings_SuperParrot, /*tp_traverse*/
  __pyx_tp_clear_10docstrings_SuperParrot, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
...
PyMODINIT_FUNC initdocstrings(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/5/docstrings.pyx":6 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/5/docstrings.pyx":9 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/5/docstrings.pyx":12 */
  return;
  __pyx_L1:;
  Py_XDECREF(__pyx_1);
  Py_XDECREF(__pyx_2);
