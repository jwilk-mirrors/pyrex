...
/* Declarations from sreeram1 */

struct __pyx_obj_8sreeram1_Person {
  PyObject_HEAD
};


static PyTypeObject *__pyx_ptype_8sreeram1_Person = 0;

/* Declarations from implementation of sreeram1 */

struct __pyx_obj_8sreeram1_Name {
  PyObject_HEAD
};


static PyTypeObject *__pyx_ptype_8sreeram1_Name = 0;
