...
/* Declarations from khavkine1 */

typedef struct __pyx_obj_9khavkine1_T __pyx_gcc33_obj_9khavkine1_T;


struct __pyx_obj_9khavkine1_T {
  PyObject_HEAD
  int (a[1]);
};

static PyTypeObject *__pyx_ptype_9khavkine1_T = 0;
static PyObject *__pyx_v_9khavkine1_b;
...
static void __pyx_f_9khavkine1_f(void (*__pyx_v_obj)) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/khavkine/khavkine1.pyx":7 */
...
static PyObject *__pyx_tp_new_9khavkine1_T(PyTypeObject *t, PyObject *a, PyObject *k) {
  PyObject *o = (*t->tp_alloc)(t, 0);
  return o;
}

static void __pyx_tp_dealloc_9khavkine1_T(PyObject *o) {
  (*o->ob_type->tp_free)(o);
}
...
PyTypeObject __pyx_type_9khavkine1_T = {
  PyObject_HEAD_INIT(0)
  0, /*ob_size*/
  "khavkine1.T", /*tp_name*/
  sizeof(struct __pyx_obj_9khavkine1_T), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_9khavkine1_T, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  0, /*tp_compare*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_9khavkine1_T, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_9khavkine1_T, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
PyMODINIT_FUNC initkhavkine1(void); /*proto*/
PyMODINIT_FUNC initkhavkine1(void) {
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("khavkine1", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  ...
  __pyx_ptype_9khavkine1_T = &__pyx_type_9khavkine1_T;

  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/khavkine/khavkine1.pyx":9 */
  Py_INCREF(Py_None);
  Py_DECREF(__pyx_v_9khavkine1_b);
  __pyx_v_9khavkine1_b = Py_None;
  return;
  __pyx_L1:;
  __Pyx_AddTraceback("khavkine1");
}
