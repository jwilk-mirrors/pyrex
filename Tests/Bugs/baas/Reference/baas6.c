...
typedef struct __pyx_obj_5baas6_DoIHaveEmptyDel __pyx_gcc33_obj_5baas6_DoIHaveEmptyDel;
typedef struct __pyx_obj_5baas6_DoIHaveGCDel __pyx_gcc33_obj_5baas6_DoIHaveGCDel;
...
struct __pyx_obj_5baas6_DoIHaveGCDel {
  PyObject_HEAD
  PyObject *foo;
};

static PyTypeObject *__pyx_ptype_5baas6_DoIHaveEmptyDel = 0;
...
static int __pyx_tp_traverse_5baas6_DoIHaveEmptyDel(PyObject *o, visitproc v, void *a) {
  return 0;
}

static int __pyx_tp_clear_5baas6_DoIHaveEmptyDel(PyObject *o) {
  return 0;
}
...
PyTypeObject __pyx_type_5baas6_DoIHaveEmptyDel = {
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_5baas6_DoIHaveEmptyDel, /*tp_traverse*/
  __pyx_tp_clear_5baas6_DoIHaveEmptyDel, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
...
PyMODINIT_FUNC initbaas6(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/baas/baas6.pyx":5 */
  return;
  __pyx_L1:;
