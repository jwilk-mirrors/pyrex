...
typedef struct __pyx_obj_5baas3_MyClass __pyx_gcc33_obj_5baas3_MyClass;
...
static PyObject *__pyx_f_5baas3_foo(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/baas/baas3.pyx":6 */
  Py_INCREF(((PyObject *)__pyx_v_c));
  Py_DECREF(((PyObject *)__pyx_v_res));
  __pyx_v_res = __pyx_v_c;

  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/baas/baas3.pyx":7 */
...
PyMODINIT_FUNC initbaas3(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/baas/baas3.pyx":4 */
  return;
  __pyx_L1:;
