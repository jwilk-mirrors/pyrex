...
static PyObject *__pyx_f_6altet1_flub(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/altet/altet1.pyx":7 */
...
static struct PyMethodDef __pyx_methods[] = {
  {"flub", (PyCFunction)__pyx_f_6altet1_flub, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};

static void __pyx_init_filenames(void); /*proto*/

PyMODINIT_FUNC initaltet1(void); /*proto*/
PyMODINIT_FUNC initaltet1(void) {
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("altet1", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/altet/altet1.pyx":9 */
  __pyx_v_6altet1_globvar = 0;
  return;
  __pyx_L1:;
  __Pyx_AddTraceback("altet1");
}
