/* Generated by Pyrex 0.9.6.4 on Sat Mar 29 13:27:43 2008 */
...
/* Declarations from altet2 */

struct __pyx_obj_6altet2_C {
  PyObject_HEAD
};
...
static PyObject *__pyx_f_6altet2_1C___iter__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r;
...
static PyObject *__pyx_tp_new_6altet2_C(PyTypeObject *t, PyObject *a, PyObject *k) {
  PyObject *o = (*t->tp_alloc)(t, 0);
  if (!o) return 0;
  return o;
}

static void __pyx_tp_dealloc_6altet2_C(PyObject *o) {
  (*o->ob_type->tp_free)(o);
}
...
PyTypeObject __pyx_type_6altet2_C = {
  PyObject_HEAD_INIT(0)
  0, /*ob_size*/
  "altet2.C", /*tp_name*/
  sizeof(struct __pyx_obj_6altet2_C), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_6altet2_C, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  0, /*tp_compare*/
  ...
  0, /*tp_iternext*/
  __pyx_methods_6altet2_C, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
...
PyMODINIT_FUNC initaltet2(void); /*proto*/
PyMODINIT_FUNC initaltet2(void) {
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("altet2", __pyx_methods, 0, 0, PYTHON_API_VERSION);
