...
/* Declarations from ewing3 */

typedef struct __pyx_obj_6ewing3_C __pyx_gcc33_obj_6ewing3_C;


struct __pyx_obj_6ewing3_C {
  PyObject_HEAD
  struct __pyx_vtabstruct_6ewing3_C *__pyx_vtab;
};

struct __pyx_vtabstruct_6ewing3_C {
  PyObject *((*f)(struct __pyx_obj_6ewing3_C *));
};
static struct __pyx_vtabstruct_6ewing3_C *__pyx_vtabptr_6ewing3_C;

static PyTypeObject *__pyx_ptype_6ewing3_C = 0;
...
static PyObject *__pyx_f_6ewing3_1C_f(struct __pyx_obj_6ewing3_C *__pyx_v_self) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/ewing/ewing3.pyx":3 */
...
static PyObject *__pyx_tp_new_6ewing3_C(PyTypeObject *t, PyObject *a, PyObject *k) {
  ...
  struct __pyx_obj_6ewing3_C *p = (struct __pyx_obj_6ewing3_C *)o;
...
static int __pyx_tp_traverse_6ewing3_C(PyObject *o, visitproc v, void *a) {
  return 0;
}

static int __pyx_tp_clear_6ewing3_C(PyObject *o) {
  return 0;
}
...
PyTypeObject __pyx_type_6ewing3_C = {
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_6ewing3_C, /*tp_traverse*/
  __pyx_tp_clear_6ewing3_C, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
...
PyMODINIT_FUNC initewing3(void) {
  ...
  *(void(**)(void))&__pyx_vtable_6ewing3_C.f = (void(*)(void))__pyx_f_6ewing3_1C_f;
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/ewing/ewing3.pyx":2 */
  return;
  __pyx_L1:;
