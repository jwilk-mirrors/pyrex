...
/* Declarations from ishimoto1 */

typedef struct __pyx_obj_9ishimoto1_A __pyx_gcc33_obj_9ishimoto1_A;


struct __pyx_obj_9ishimoto1_A {
  PyObject_HEAD
};

static PyTypeObject *__pyx_ptype_9ishimoto1_A = 0;
...
static PyObject *__pyx_f_9ishimoto1_1A___getitem__(PyObject *__pyx_v_self, PyObject *__pyx_v_x) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/ishimoto/ishimoto1.pyx":4 */
...
static int __pyx_tp_traverse_9ishimoto1_A(PyObject *o, visitproc v, void *a) {
  return 0;
}

static int __pyx_tp_clear_9ishimoto1_A(PyObject *o) {
  return 0;
}
static PyObject *__pyx_sq_item_9ishimoto1_A(PyObject *o, int i) {
  PyObject *r;
...
PyTypeObject __pyx_type_9ishimoto1_A = {
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_9ishimoto1_A, /*tp_traverse*/
  __pyx_tp_clear_9ishimoto1_A, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
...
PyMODINIT_FUNC initishimoto1(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/ishimoto/ishimoto1.pyx":3 */
  return;
  __pyx_L1:;
