...
PyMODINIT_FUNC initking1(void); /*proto*/
PyMODINIT_FUNC initking1(void) {
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("king1", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  ...
  /* "/Local/Projects/D/Pyrex/Source/Tests/Bugs/King/king1.pyx":3 */
  return;
  __pyx_L1:;
  __Pyx_AddTraceback("king1");
}
