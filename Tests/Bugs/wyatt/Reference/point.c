...
typedef struct __pyx_obj_5point_Point __pyx_gcc33_obj_5point_Point;
...
static PyObject *__pyx_tp_new_5point_Point(PyTypeObject *t, PyObject *a, PyObject *k) {
  PyObject *o = __pyx_ptype_6vector_Vector->tp_new(t, a, k);
  return o;
}
...
PyMODINIT_FUNC initpoint(void) {
  ...
  if (PyObject_SetAttrString(__pyx_m, "Point", (PyObject *)&__pyx_type_5point_Point) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; goto __pyx_L1;}
  __pyx_ptype_5point_Point = &__pyx_type_5point_Point;

  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/wyatt/point.pyx":2 */
  return;
  __pyx_L1:;
