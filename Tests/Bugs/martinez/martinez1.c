...
/* Declarations from martinez1 */


/* Declarations from implementation of martinez1 */
...
static int __pyx_f_9martinez1_f(void) {
  ...
  /* "/Local/Projects/D/Pyrex/Source/Tests/Bugs/martinez/martinez1.pyx":8 */
...
PyMODINIT_FUNC initmartinez1(void) {
  ...
  /* "/Local/Projects/D/Pyrex/Source/Tests/Bugs/martinez/martinez1.pyx":6 */
  return;
  __pyx_L1:;
