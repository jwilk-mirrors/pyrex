/* Generated by Pyrex 0.9.6.4 on Sun Mar 30 09:51:52 2008 */
...
static PyObject *__pyx_f_7behnel7_test(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_7behnel7_test(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
...
static struct PyMethodDef __pyx_methods[] = {
  {"test", (PyCFunction)__pyx_f_7behnel7_test, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};

static void __pyx_init_filenames(void); /*proto*/

PyMODINIT_FUNC initbehnel7(void); /*proto*/
PyMODINIT_FUNC initbehnel7(void) {
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("behnel7", __pyx_methods, 0, 0, PYTHON_API_VERSION);
