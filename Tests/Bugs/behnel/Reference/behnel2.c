...
/* Declarations from behnel2 */




/* Implementation of behnel2 */
...
PyMODINIT_FUNC initbehnel2(void); /*proto*/
PyMODINIT_FUNC initbehnel2(void) {
  PyObject *__pyx_1 = 0;
  int __pyx_2;
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("behnel2", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/behnel/behnel2.pyx":1 */
