...
static PyObject *__pyx_n_mylist;
...
static PyObject *__pyx_f_5jiba5_f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/jiba/jiba5.pyx":4 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/jiba/jiba5.pyx":5 */
...
static __Pyx_InternTabEntry __pyx_intern_tab[] = {
  {&__pyx_n_f, "f"},
  {&__pyx_n_mylist, "mylist"},
  {0, 0}
};

static struct PyMethodDef __pyx_methods[] = {
  {"f", (PyCFunction)__pyx_f_5jiba5_f, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};

static void __pyx_init_filenames(void); /*proto*/

PyMODINIT_FUNC initjiba5(void); /*proto*/
PyMODINIT_FUNC initjiba5(void) {
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("jiba5", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/Bugs/jiba/jiba5.pyx":1 */
  return;
  __pyx_L1:;
  __Pyx_AddTraceback("jiba5");
}
