...
static PyObject *__pyx_f_7pyclass_4Spam_eggs(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/4/pyclass.pyx":4 */
...
PyMODINIT_FUNC initpyclass(void); /*proto*/
PyMODINIT_FUNC initpyclass(void) {
  PyObject *__pyx_1 = 0;
  PyObject *__pyx_2 = 0;
  PyObject *__pyx_3 = 0;
  PyObject *__pyx_4 = 0;
  __pyx_init_filenames();
  __pyx_m = Py_InitModule4("pyclass", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/4/pyclass.pyx":1 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/4/pyclass.pyx":3 */
  ...
  if (PyObject_SetAttr(__pyx_m, __pyx_n_Spam, __pyx_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; goto __pyx_L1;}
