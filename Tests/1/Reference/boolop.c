/* Generated by Pyrex 0.9.5.2 on Fri Mar 30 15:18:21 2007 */
...
static void __pyx_f_6boolop_foo(PyObject *__pyx_v_obj1,PyObject *__pyx_v_obj2,PyObject *__pyx_v_obj3,PyObject *__pyx_v_obj4,PyObject *__pyx_v_obj5) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/1/boolop.pyx":5 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/1/boolop.pyx":6 */
  __pyx_1 = __pyx_v_bool1;
  if (!__pyx_1) {
    __pyx_1 = __pyx_v_bool2;
  }
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/1/boolop.pyx":7 */
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/1/boolop.pyx":8 */
  __pyx_1 = __pyx_v_bool1;
  if (__pyx_1) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/1/boolop.pyx":9 */
  __pyx_1 = __pyx_v_bool1;
  if (__pyx_1) {
    __pyx_1 = (__pyx_v_f != 0);
  }
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/1/boolop.pyx":10 */
  __pyx_1 = __pyx_v_bool1;
  if (__pyx_1) {
    __pyx_1 = __pyx_v_bool2;
    if (__pyx_1) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/1/boolop.pyx":11 */
  __pyx_1 = __pyx_v_bool1;
  if (!__pyx_1) {
    __pyx_1 = __pyx_v_bool2;
    if (__pyx_1) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/1/boolop.pyx":12 */
  __pyx_2 = __pyx_v_obj1;
  Py_INCREF(__pyx_2);
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/1/boolop.pyx":13 */
...
PyMODINIT_FUNC initboolop(void) {
  ...
  /* "/Local/Projects/C/Pyrex/Source/Tests/1/boolop.pyx":1 */
  return;
  __pyx_L1:;
